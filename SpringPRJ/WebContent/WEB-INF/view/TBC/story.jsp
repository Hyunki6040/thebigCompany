...
%>
    ...
    <body id="body" class="enlarged" data-keep-enlarged="true">
				...
				<div id="sidebar-menu">
					...
					%>
						...
						<ul class="nav-second-level" aria-expanded="false">
								<li><a href="javascript:void(0);"
							class="nav-link right-bar-toggle waves-effect waves-light">페이지 </a></li>
					...
					<div class="row filterable-content">
						...
						<div class="col-sm-6 col-xl-3 filter-item ${row.tag}">
							<div class="gal-box">
									...
									<div class="overlay">
								<div>
										<a href="#" onclick="javascript:getPhoto('${row.content}','${row.title}');">
										<img src="../img/add_btn.png" class="img-fluid" alt="work-thumbnail" style="width: 10%;height: 10%;margin-left: 46%;margin-top: 22%;margin-bottom: 9%;">
										</a>
									</div>

										<div class="gall-info" style="height: 15%;padding: 0px;background-color: unset;">
											<h4 class="font-16 mt-0" style="font-family: 'Nanum Pen Script', cursive; color: white;">${row.title}</h4>
											<% if(user_right.equals("1")) { %>
											<button type="button" class="btn btn-danger"
												onclick="delete_confirm(${row.img_no});">삭제</button><button type="button" class="btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal${row.img_no}">수정</button>
												
										
											<form action="../ImgdeleteBoard.do" id="delete_frm${row.img_no}">
												<input type="hidden" name="board_no" value="${row.img_no}">
												<input type="hidden" name="page" value="TBCstory">
												<input type="hidden"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
												...
												<div class="modal-body p-4">
													<input type="hidden" value="TBCstory" name="page">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="form-group">
																<label for="field-3" class="control-label">내용 이미지들 링크[반점(,)으로 구분]</label> <br>
																	 <textarea class="autosize" onkeydown="resize(this)"
																onkeyup="resize(this)" placeholder="내용을 적어주세요!" name="content" >${row.content}</textarea>
									<script>
																function resize(
																		obj) {
                       ...
                       <div>
                            <div class="inbox-widget">
								...
								<form action="/ImgBoardProc.do">
									...
									<input type="hidden" value="TBCstory" name="page"> 
									이미지 링크(구글드라이브)<br><input type="text" name="image"><br>
									제목 <br><input type="text" name="title"><br>
									내용 이미지들 링크[반점(,)으로 구분] <br><textarea class="autosize" onkeydown="resize(this)"
        ...
        <%} %>
        <!-- Right bar overlay-->
		<div class="rightbar-overlay" style="display: none;"></div>
