...
<head>
        ...
        <style type="text/css">
			...
			@font-face {font-family: 'OmniGothic040'; src: url('../fonts/OmniGothic040.ttf') format('truetype');}
			.filter-menu a {
			color: white;
			}
			.filter-menu a:hover {
            ...
            <div class="content-page" style="margin-left: 0px !important;">
				...
				<div class="row">
						<div class="col-12" style="padding-left: 0px;">
							<img id="top_bar" alt=""
								src="../img/tbc/bar_areas.jpg">
						</div>
					</div>
					
					<div class="row">
						<div class="col-12" id="background" style="padding-left: 0px;padding-right: 0px; background-position: center 0;background-repeat: no-repeat;background-image: url('../img/tbc/plan_co.jpg');">
							
							<!-- Filter -->
							<div class="text-center filter-menu">
									<a href="javascript: changeBackground(0);"
									class="filter-menu-item active" id="singer" data-rel="co" style="margin-right: 0px">기업행사</a>
									<a href="javascript: changeBackground(1);"
									class="filter-menu-item" id="singer" data-rel="univ">대학행사</a>
									<a href="javascript: changeBackground(2);"
									class="filter-menu-item" id="mc" data-rel="broad">방송활용</a><br id="background_br">
									<a href="javascript: changeBackground(3);"
									class="filter-menu-item" id="mc" data-rel="artist">연예인행사</a>
									<a href="javascript: changeBackground(4);"
									class="filter-menu-item" id="mc" data-rel="local">지역축제 </a>
									
									<script type="text/javascript">
										function changeBackground(num) {
											if(num==0){
												document.getElementById("background").style.backgroundImage = "url('../img/tbc/plan_co.jpg')";
												document.getElementById("contents_icon").src = "../img/tbc/area_icon_co.png";
												document.getElementById("contents").innerHTML = "기업 임직원들의 협동심과 애사심을 키우고 <br id=\"mobile_br\">회사 업무에 지친 임직원들이 <br id=\"mobile_br\">몸과 마음을 힐링 할 수 있는 기회를 만들어 주며,<br>때로는 기업의 프로모션등과 같은 프로젝트를 <br id=\"mobile_br\">함께하여 완벽한 행사를 만들어드립니다.<br><br>시무식 / 창립행사 / 송년회 /<br id=\"mobile_br\"> 워크샾 / 세미나 / 프로모션";
											}else if(num==1){
												document.getElementById("background").style.backgroundImage = "url('../img/tbc/plan_univ.jpg')";
												document.getElementById("contents_icon").src = "../img/tbc/area_icon_univ.png";
												document.getElementById("contents").innerHTML = "20대 성인이 되어 처음으로 맞이하는 <br id=\"mobile_br\">대학 생활의 가이드가 되어주는 O.T부터<br>학생들의 단합과 협동력을 길러주는 M.T,<br>대학생활에 지치고 무료한 <br id=\"mobile_br\">대학 생활의 활력소가 되어주는 대학 축제등<br>대학생활의 모든 행사를 <br id=\"mobile_br\">더욱 완벽하게 만들어드립니다.<br><br>O.T / M.T / 대학 축제 / 단과대 행사 /<br id=\"mobile_br\"> 동아리 행사 / 대학 프로모션 행사";
											}else if(num==2){
												document.getElementById("background").style.backgroundImage = "url('../img/tbc/plan_broad.jpg')";
												document.getElementById("contents_icon").src = "../img/tbc/area_icon_broad.png";
												document.getElementById("contents").innerHTML = "방송을 직접 접하지 못하는 일반적인 대중들이 <br id=\"mobile_br\">각종 라디오의 공개방송등과 같은 방법을 통하여<br>직접 방송을 접함과 더불어 <br id=\"mobile_br\">기업의 팀빌딩, 게임회사의 유저간담회등의 행사를<br>방송국의 부스(게임방송의 게임부스)등을 활용하여 직접적인 참여가 가능한 행사를 만들어드립니다.<br><br>지역 축제 라디오 공개방송 / <br id=\"mobile_br\">대학 축제 라디오 공개방송 / <br id=\"mobile_br\">기업 팀빌딩 / 유저 간담회 / 팬미팅";
											}else if(num==3){
												document.getElementById("background").style.backgroundImage = "url('../img/tbc/plan_artist.jpg')";
												document.getElementById("contents_icon").src = "../img/tbc/area_icon_artist.png";
												document.getElementById("contents").innerHTML = "자주 접하지 못하는 연예인과 팬과의 만남을 통하여 연예인과 팬이 하나 되는 자리를 만들며<br>또한 기업의 제품 홍보나 <br id=\"mobile_br\">기업 브랜드 런칭을 위한 팬미팅등<br>연예인과 함께 할 수 있는 <br id=\"mobile_br\">다양한 행사를 만들어 드립니다.<br><br>팬미팅 / 콘서트 / 펜사인회 / <br id=\"mobile_br\">기업 브랜드 론칭 행사 / 쇼케이스 / 시사회";
											}else if(num==4){
												document.getElementById("background").style.backgroundImage = "url('../img/tbc/plan_local.jpg')";
												document.getElementById("contents_icon").src = "../img/tbc/area_icon_local.png";
												document.getElementById("contents").innerHTML = "각 지역의 지역사회 발전과 더불어 <br id=\"mobile_br\">지역의 구성원 간의 소통의 장을 열어주며<br>또한 지역의 특산품 및 명소를 홍보하고 알릴 수 있는 축제를 개최하여<br>관광객을 유치함으로 <br id=\"mobile_br\">보다 활발한 지역 시장의 발전과 <br id=\"mobile_br\">지역을 알릴 수 있는 행사를 만들어드립니다.<br><br>지역 축제 / 특산품 축제 / 시민의 날 / <br id=\"mobile_br\">노래자랑 / 시장 홍보 행사 / 지자체 행사";
											}
					...
					<div class="row">
						<div class="col-12" style="padding-left: 0px; text-align: center">
							<img id="contents_icon" style="height:auto;" alt=""
								src="../img/tbc/area_icon_co.png">
						</div>
						<div class="col-12" style="padding-left: 0px;">
							<h5 id="contents" style="font-family: OmniGothic040; text-align: center;">
							기업 임직원들의 협동심과 애사심을 키우고 <br id=\"mobile_br\">회사 업무에 지친 임직원들이 <br id=\"mobile_br\">몸과 마음을 힐링 할 수 있는 기회를 만들어 주며,<br>때로는 기업의 프로모션등과 같은 프로젝트를 <br id=\"mobile_br\">함께하여 완벽한 행사를 만들어드립니다.<br><br>시무식 / 창립행사 / 송년회 /<br id=\"mobile_br\"> 워크샾 / 세미나 / 프로모션
							</h5>
						</div>
					</div>
						...
						<div class="col-12" style="padding-left: 0px; padding-right: 0px;">
							<div id="footer_wrap">
								<div class="wrap" id="wrap"
									...
									<div class="f_l" style="width: 340px;">
										...
										<address style="width: 339px;">
											...
											copyright (c) TBC. all rights reserved <a href="./main.do"><img
												alt="" src="../img/tbc.png" style="width: 235px;"></a>
										</address>
									</div>
									<div class="f_r">
										<div class="f_link">
								...
								<script type="text/javascript">window.onload = function() {var para = getCookie("DesktopMode");if(para == "true"){document.getElementById("turn_mobile").style.display= "block";}else{document.getElementById("turn_mobile").style.display= "none";}}</script><button onclick="javascript:desktopMode();" id="turn_mobile"style="max-width: 100%; height: 200px; width: 1920px;font-size: xx-large;display:none;">모바일 버전으로</button><div class="row" id="footer_wrap1" style="text-align: center; margin-top:100px"><div class="col-12	"><button onclick="desktopMode()" id="turn_mobile"style="max-width: 100%; height: 56px; width: 441px;">PC 버전으로</button></div>
									...
									<div class="col-12">
										<button onclick="desktopMode()" id="turn_mobile">PC
											버전으로</button>
									</div>
