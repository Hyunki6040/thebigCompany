		...
		<!-- Left Sidebar End -->
            ...
            <div class="content-page" style="margin-left: 0px !important;">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-3">
							<div id="part">임원 및 기획 연출<br/>PART</div>
							<div id="cap">광고주 입장에서 이끌어내는 세련되고 참신한 기획, 연출로 합리적 예산, 최상의 퀄리티를
								완성하는 전문가 그룹입니다.</div>
						</div>
						<div class="col-lg-9">
							<div class="row">
					...
					<div class="row">
						<div class="col-lg-3">
							...
							<div id="cap">컨셉 기획부터 마케팅 전략까지 원스톱 솔루션을 제공하며 전문가 집단의 열정과
								전문지식의 노하우로 운영됩니다.</div>
						</div>
						<div class="col-lg-9">
								...
								<div class="col-lg-4">
									<div class="text-center card-box">
										<div class="pt-2 pb-2">
											...
											<h4 class="mt-3 font-17">
												<a href="extras-profile.html" class="text-dark">Mark K.
													Horne</a>
											</h4>
											<p class="text-muted">
												@Director <span> | </span> <span> <a href="#"
													class="text-pink">profileq.com</a>
												</span>
											</p>

											<p class="text-muted font-13 mb-3">Hi I'm Johnathn
												Deo,has been the industry's standard dummy text ever since
								...
								<div class="col-lg-4">
									<div class="text-center card-box">
										<div class="pt-2 pb-2">
											...
											<h4 class="mt-3 font-17">
												<a href="extras-profile.html" class="text-dark">James M.
													Fonville</a>
											</h4>
											<p class="text-muted">
												@Manager <span> | </span> <span> <a href="#"
													class="text-pink">coolweb.com</a>
												</span>
											</p>
								...
								<div class="col-lg-4">
									<div class="text-center card-box">
										<div class="pt-2 pb-2">
											...
											<h4 class="mt-3 font-17">
												<a href="extras-profile.html" class="text-dark">Jade M.
													Walker</a>
											</h4>
											<p class="text-muted">
												@Programmer <span> | </span> <span> <a href="#"
													class="text-pink">supported.com</a>
												</span>
											</p>
					...
					<div class="row">
						<div class="col-lg-3">
							<div id="part">디자인 본부<br/>PART</div>
							<div id="cap">다양한 클라이언트의 과제를 정확히 분석하고 최적화된 브랜딩 전략을 제시하는 디자인
								컨설팅 전문 그룹입니다.</div>
						</div>
						<div class="col-lg-9">
								...
								<div class="col-lg-4">
									<div class="text-center card-box">
										<div class="pt-2 pb-2">
											...
											<h4 class="mt-3 font-17">
												<a href="extras-profile.html" class="text-dark">Marie E.
													Tate</a>
											</h4>
											<p class="text-muted">
												@Webdeveloper <span> | </span> <span> <a href="#"
													class="text-pink">website.com</a>
												</span>
											</p>
								...
								<div class="col-lg-4">
									<div class="text-center card-box">
										<div class="pt-2 pb-2">
											...
											<h4 class="mt-3 font-17">
												<a href="extras-profile.html" class="text-dark">Elyse D.
													Davidson</a>
											</h4>
											<p class="text-muted">
												@Webdesigner <span> | </span> <span> <a href="#"
													class="text-pink">dumosite.com</a>
												</span>
											</p>
								...
								<div class="col-lg-4">
									<div class="text-center card-box">
										<div class="pt-2 pb-2">
											...
											<h4 class="mt-3 font-17">
												<a href="extras-profile.html" class="text-dark">Sarah E.
													Goin</a>
											</h4>
											<p class="text-muted">
												@Manager <span> | </span> <span> <a href="#"
													class="text-pink">webion.com</a>
												</span>
											</p>
					...
					<div class="row">
						<div class="col-lg-3">
							<div id="part">프로덕션 본부<br/>PART</div>
							<div id="cap">작품의 퀄리티를 위해 최첨단 장비와 국내 최정상의 스페셜리스트들을 세분화하여
								운영하고 있습니다.</div>
						</div>
						<div class="col-lg-9">
							<div class="row">
