...
<head>
        ...
        <style type="text/css">
			...
			.enlarged .left-side-menu {height: -webkit-fit-content;
	display: -ms-table;
...
#wrapper{
		...
		<script type="text/javascript">
									...
									function select_click() {
										if(select=="singer"){
											document.getElementById("singer").click();
											finish = 1;
										}else if(select=="mc"){
											document.getElementById("mc").click();
											finish = 1;
										}else if(select=="performance"){
											document.getElementById("performance").click();
											finish = 1;
										}else if(select=="teller"){
											document.getElementById("teller").click();
											finish = 1;
										}else{
									...
									$(document).ready(function() { if(select=="singer"){
											document.getElementById("singer").click();
											select_click();
										}else if(select=="mc"){
											document.getElementById("mc").click();
									...
									function ChangeTitle(num) {
										if(num == 1){
											document.getElementById("top_bar").src = "../img/tbc/bar_singer.jpg";
											document.getElementById("singer_display").classList.add( 'active' );
											
										}else if(num == 2){
											document.getElementById("top_bar").src = "../img/tbc/bar_mc.jpg";
											document.getElementById("mc_display").classList.add( 'active' );
										}else if(num == 3){
											document.getElementById("top_bar").src = "../img/tbc/bar_performance.jpg";
											document.getElementById("performance_display").classList.add( 'active' );
										}else if(num == 4){
											document.getElementById("top_bar").src = "../img/tbc/bar_teller.jpg";
											document.getElementById("teller_display").classList.add( 'active' );
										}else{
											document.getElementById("top_bar").src = "../img/tbc/bar_lineup.jpg";
...
<script>
												grecaptcha.ready(function() {
													grecaptcha.execute('6Ldbxc4UAAAAADdY7H1Ri0953oEb20yCOZkP2GZ0', {
														...
														document.getElementById('g-recaptcha-response-delete').value = token;
													})
												});
											</script>
<script>
		...
		<!-- Left Sidebar End -->
            ...
            <div class="content-page" style="margin-left: 0px !important;">
				...
				<div class="row" style="margin-bottom: 25px;">
					...
					<div class="row">
						<div class="col-12">
							<div class="text-center filter-menu">
								<a href="./lineup.do" class="filter-menu-item" id="all_display"
									data-rel="all">All</a> 
									
									<a href="./lineup.do?select=singer"
									class="filter-menu-item" id="singer_display" data-rel="singer">가수</a>
									<a href="./lineup.do?select=mc"
									class="filter-menu-item" id="mc_display" data-rel="mc">사회자</a>
									<a href="./lineup.do?select=performance"
									class="filter-menu-item" id="performance_display" data-rel="performance">퍼포먼스</a>
									<a href="./lineup.do?select=teller"
									class="filter-menu-item" id="teller_display" data-rel="teller">강연자</a>
						...
						<div class="col-12">
							<div class="text-center filter-menu">
								<a href="javascript: ChangeTitle(0);" class="filter-menu-item" id="all"
									...
									class="filter-menu-item" id="singer" data-rel="singer">가수</a>
									<a href="javascript: ChangeTitle(2);"
									class="filter-menu-item" id="mc" data-rel="mc">사회자</a>
									<a href="javascript: ChangeTitle(3);"
									class="filter-menu-item" id="performance" data-rel="performance">퍼포먼스</a>
									<a href="javascript: ChangeTitle(4);"
									class="filter-menu-item" id="teller" data-rel="teller">강연자</a>
					...
					<!-- 메뉴 -->
					<%if(select.equals("singer")){%>
						<div class="col-12 filter-item web singer hiphop man woman girls boys trot band">
							<div class="text-center filter-menu">
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="hiphop">힙합</a>
								 	<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="man">남자 가수</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="woman">여자 가수</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="girls">걸그룹</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="boys">보이그룹</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="band">밴드, 락</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="trot">트로트</a>
							</div>
						</div>
						<%}else if(select.equals("performance")){ %>
						<!-- end col -->
						<div class="col-12 filter-item web performance korean dancer classic perpom">
							<div class="text-center filter-menu">
								<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="perpom">퍼포먼스</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="dancer">댄스</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="classic">뮤직</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="korean">전통</a>
									
							</div>
						</div>
						<%}else if(select.equals("mc")){ %>
						<!-- end col -->
						<div class="col-12 filter-item web mc man_anna woman_anna geg promc broad">
							<div class="text-center filter-menu">
								 <a href="javascript: void(0);"
									class="filter-menu-item" data-rel="man_anna">남자 아나운서</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="woman_anna">여자 아나운서</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="geg">코미디언</a>
									<a href="javascript: void(0);"
									class="filter-menu-item" data-rel="promc">전문 MC</a>
							...
							<div class="gal-box">
								...
								<div>
										...
										<div class="gall-info" style="height: 15%;padding: 0px;background-color: unset;">
											<h4 class="font-16 mt-0" style="font-family: 'Nanum Pen Script', cursive; color: white;">${row.title}
											<% if(user_right.equals("1")) { %>
                                            ...
                                            <div class="modal-content">
												...
												<div class="modal-body p-4">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="form-group">
																<label for="field-3" class="control-label">썸네일(구글드라이브)</label> <br> <input type="text" name="image"
													...
													<div class="row">
														<div class="col-md-12">
															<div class="form-group">
																<label for="field-3" class="control-label">상세이미지(구글드라이브)</label> <br> <input type="text" name="image_01"
																	placeholder="${row.img_01}" value="${row.img_01}" style="width: 100%;">
															</div>
														</div>
													</div>
													<div class="row">
                       ...
                       <div>
							...
							<div class="inbox-item" style="height: 600px;">
								<form action="/ImgBoardProc.do">
									...
									<input type="hidden" value="TBClineup" name="page"> 분류<br>
									<select name="tag1" id="tag1" onchange="chageSelect()">
										<option value="singer">가수</option>
										<option value="mc">사회자</option>
										<option value="performance">퍼포먼스</option>
										<option value="teller">강연자</option>
									</select> <select name="singertag" id="singertag"
										style="display: block;">
										<option value="hiphop">힙합</option>
										<option value="man">남자가수</option>
										<option value="woman">여자가수</option>
										<option value="girls">걸그룹</option>
										<option value="boys">보이그룹</option>
										<option value="band">밴드, 락</option>
										<option value="trot">트로트</option>
									</select>
									<select name="mctag" id="mctag"
										style="display: block;">
										<option value="woman_anna">여자아나운서</option>
										<option value="man_anna">남자 아나운서</option>
										<option value="geg">코미디언</option>
										<option value="promc">전문mc</option>
									</select> <select name="performancetag" id="performancetag"
										style="display: none;">
										<option value="perpom">퍼포먼스</option>
										<option value="dancer">댄스</option>
										<option value="classic">뮤직</option>
										<option value="korean">전통</option>
									</select> <br> 썸네일(구글드라이브)<br>
									<input type="text" name="image"><br>
									상세이미지(구글드라이브)<br>
									<input type="text" name="image_01"><br> 제목 <br>
								...
								function chageSelect() {
									...
									if(value == 'singer'){
										...
										document.getElementById('performancetag').style.display = 'none';
										document.getElementById('mctag').style.display = 'none';
									}else if(value == 'performance'){
										document.getElementById(value + 'tag').style.display = 'block';
										
										document.getElementById('singertag').style.display = 'none';
										document.getElementById('mctag').style.display = 'none';
									}else if(value == 'mc'){
										document.getElementById(value + 'tag').style.display = 'block';
								...
								<% if(user_right.equals("1")) { %>
											<form action="../ImgdeleteBoard.do" id="delete_frm${row.img_no}">
												...
												<input type="hidden" name="page" value="TBClineup">
												<input type="text"
													id="g-recaptcha-response-delete" name="g-recaptcha-response">
