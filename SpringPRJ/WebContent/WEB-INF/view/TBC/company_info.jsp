...
<%@page import="poly.dto.SingleDTO"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	SingleDTO sDTO = (SingleDTO)request.getAttribute("sDTO");
%>
...
<head>
	...
	<script type="text/javascript">
		function getId(url) {
			/* const regExp = "/^.*(youtu\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*"; */
			var regExp = /^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/;
			var matchy = url.match(regExp);
			console.log(matchy);
			console.log(matchy[1]);
			console.log(matchy[2]);
			return (matchy && matchy[2].length === 11) ? matchy[2] : "null";
		}
		
	var videoId = getId('https://youtu.be/ES-LOnSqUdQ');
	var iframeMarkup = '<iframe width="1260" height="705" src="https://www.youtube.com/embed/'
	    + videoId + '?rel=0&amp;showinfo=0&amp;wmode=opaque" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>';

	console.log('Video ID: ', videoId);
	$('#youtubeEmbed').html(iframeMarkup);
	</script>
</head>
	...
	<body class="enlarged" data-keep-enlarged="true">
			...
			<div class="slimscroll-menu">
				...
				<div id="sidebar-menu">
					...
					onmouseout="javascript:ChangenameOrigin(2)">
							...
							<ul class="nav-second-level" aria-expanded="false">
								<li><a href="./business_areas.do">사업분야</a></li>
								<li><a href="javascript: void(0);" class="waves-effect">
										<span> 시스템정보 </span> <span class="menu-arrow"></span>
								</a>
									<ul class="nav-second-level" aria-expanded="false">
										<li><a href="../TBS/stage.do" target="_blank">무대</a></li>
										<li><a href="../TBS/sound.do" target="_blank">음향</a></li>
										<li><a href="../TBS/light.do" target="_blank">조명</a></li>
										<li><a href="../TBS/led.do" target="_blank">LED</a></li>
										<li><a href="../TBS/repeater.do" target="_blank">중계</a></li>
										<li><a href="../TBS/effect.do" target="_blank">특수효과</a></li>
										<li><a href="../TBS/structure.do" target="_blank">구조물</a></li>
										<li><a href="../TBS/exhibition.do" target="_blank">전시</a></li>
									</ul></li>
							</ul></li>
							...
							<script type="text/javascript">
							 function Changename(num) {
								 	if(num == 1){
								 		...
								 		document.getElementById("MenuName"+ num).innerHTML = "공연";
								 	}else if(num == 5){
								...
								function ChangenameOrigin(num) {
									if(num == 1){
								 		...
								 		document.getElementById("MenuName"+ num).innerHTML = "Performance";
								 	}else if(num == 5){
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-12" style="padding-left: 0px;">
							<img id="top_bar" alt="" src="../img/tbc/bar_company_info.jpg">
						</div>
					</div>
						...
						<div class="col-12" style="padding-left: 0px; padding-right: 0px;">
							...
							<div class="swiper-container">
								<div class="parallax-bg"
									style="background-image: url(../img/tbc/company_info.jpg)"
					...
					<div class="row" id="pc_info">
						<div class="col-12" style="padding-left: 0px; padding-right: 0px;">
							<img src="../img/tbc/company_info.jpg" alt="TBC"
								style="max-width: 100%; height: auto;" /> <img
								src="../img/tbc/timeline.jpg" alt="TBC"
					...
					<div class="row">
						<div class="col-12" style="padding-left: 0px; padding-right: 0px;">
							<div id="footer_wrap">
								<div class="wrap" id="wrap"
									...
									<div class="f_l" style="width: 340px;">
										...
										<address style="width: 339px;">
											...
											3동 103호<br /> TEL 032-710-6244<span></span>FAX 032-710-6245
											<br /> thebigc@thebigc.kr <br /> 사업자등록번호 : 218-81-73160 <br />
											<br /> copyright (c) TBC. all rights reserved <a
												href="./main.do"><img alt="" src="../img/tbc.png"
												style="width: 235px;"></a>
										</address>
									</div>
									<div class="f_r">
								...
								<script type="text/javascript">window.onload = function() {var para = getCookie("DesktopMode");if(para == "true"){document.getElementById("turn_mobile").style.display= "block";}else{document.getElementById("turn_mobile").style.display= "none";}}</script>
								<button onclick="javascript:desktopMode();" id="turn_mobile"
									style="max-width: 100%; height: 200px; width: 1920px; font-size: xx-large; display: none;">모바일
									버전으로</button>
								<div class="row" id="footer_wrap1"
									style="text-align: center; margin-top: 100px">
									<div class="col-12	">
										<button onclick="desktopMode()" id="turn_mobile"
											style="max-width: 100%; height: 56px; width: 441px;">PC
											버전으로</button>
									</div>
									<div class="col-12">copyright (c) TBC. all
										rights reserved</div>
									<div class="col-12">
		...
		<div class="right-bar">
			...
			<div class="slimscroll-menu" style="height: 800px;">
				...
				<div class="tab-content pl-3 pr-3" style="padding-bottom: 70%;">
					...
					<div>
						<div class="inbox-widget">
							<%-- <div style="margin-bottom: 4%;">
								<h5 class="mt-0">영상</h5>
								<div class="inbox-item" style="padding-top: 0;">
									<input style="width: 95%" type="text" name="videoUrl" value="<%=CmmUtil.nvl(sDTO.getContent()) %>"
										placeholder="url을 입력하세요">
								</div>
							</div> --%>

							<%-- <div>
								<h5 class="mt-0">사진 - 구글드라이브 이미지 주소</h5>
								<div class="inbox-item" style="padding-top: 0;">
									<input style="width: 95%" type="text" name="googleDirveUrl"
										value="<%=CmmUtil.nvl(sDTO.getContent()) %>" placeholder="url을 입력하세요">
									<button class="" onclick="alert(1)">확인</button>
								</div>
							</div> --%>
