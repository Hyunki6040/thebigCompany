...
.nav-second-level li a:hover, .nav-thrid-level li a:focus,
...
#wrapper{
		...
		.content-page {margin-left: 0px !important;padding-left: 0px;padding-right: 0px;margin-left: 0px !important;padding-left: 0px;padding-right: 0px;
		}
		.dropdown-menu {
    ...
    <body class="enlarged" data-keep-enlarged="true">
		...
		<div class="content-page" style="margin-left: 0px !important;">
			<div class="content">
					...
					<div class="col-12">
						...
						<div
							...
							<div class="swiper-wrapper"
								style="transition-duration: 0ms; transform: translate3d(-11700px, 0px, 0px);">
								<div class="swiper-slide"
									style="width: 100%; margin-right: 30px;">
									<div class="cropping">
										<img src="../img/tbc/main_banner1.jpg" style="height: auto;"
											id="img1">
									</div>
								</div>
								<div class="swiper-slide"
									style="width: 100%; margin-right: 30px;">
									<div class="cropping">
										<img src="../img/tbc/main_banner2.jpg" style="height: auto;"
											id="img2">
									</div>
								</div>
								<div class="swiper-slide"
									style="width: 100%; margin-right: 30px;">
									<div class="cropping">
										<img src="../img/tbc/main_banner3.jpg" style="height: auto;"
											id="img3">
									</div>
								</div>
								...
								<div class="swiper-slide"
									style="width: 100%; margin-right: 30px;">
									<div class="cropping">
										<img src="../img/tbc/main_banner4.jpg" style="height: auto;"
											id="img4">
									</div>
								</div>
								<div class="swiper-slide"
									style="width: 100%; margin-right: 30px;">
									<div class="cropping">
										<img src="../img/tbc/main_banner5.jpg" style="height: auto;"
											id="img5">
									</div>
								</div>
								<div class="swiper-slide"
									style="width: 100%; margin-right: 30px;">
									<div class="cropping">
										<img src="../img/tbc/main_banner6.jpg" style="height: auto;"
											id="img6">
									</div>
								</div>
				...
				<div class="row" id="pc_main">
					<div class="col-lg-3" style="text-align: center; margin-left: 5%;">
						<div onmouseover="javascript:main_src_on(0);"
							onmouseout="javascript:main_src(0)">
							<a href="./business_areas.do"><img
								src="../img/tbc/main_areas.jpg" id="main_img0"
								style="max-width: 100%; height: auto; zoom: 1.2;" alt="행사기획" /></a>
						</div>
					</div>
					<div class="col-lg-3" style="text-align: center;">
						<div onmouseover="javascript:main_src_on(1);"
							onmouseout="javascript:main_src(1)">
							<a href="./lineup.do"><img src="../img/tbc/main_lineup.jpg" id="main_img1"
								style="max-width: 100%; height: auto; zoom: 1.2;" alt="매니지먼트" /></a>
						</div>
					</div>
					<div class="col-lg-3" style="text-align: center;">
						<div onmouseover="javascript:main_src_on(2);"
							onmouseout="javascript:main_src(2)">
							<a href="../TBS/main.do" target="_blank"><img
								src="../img/tbc/main_system.jpg" id="main_img2"
								style="max-width: 100%; height: auto; zoom: 1.2;" alt="시스템기획" /></a>
						</div>
					</div>
					<div class="col-lg-3" style="text-align: center;">
						<div onmouseover="javascript:main_src_on(3);"
							onmouseout="javascript:main_src(3)">
							<a href="./portfolio.do"><img
								src="../img/tbc/main_portfolio.jpg" id="main_img3"
								style="max-width: 100%; height: auto; zoom: 1.2;" alt="포트폴리오" /></a>
						</div>
					</div>
					
					<script type="text/javascript">
					function main_src(num) {
						if(num == 0){
							document.getElementById("main_img" + num).src = "../img/tbc/main_areas.jpg";
						}else if(num == 1){
							document.getElementById("main_img" + num).src = "../img/tbc/main_lineup.jpg";
						}else if(num == 2){
							document.getElementById("main_img" + num).src = "../img/tbc/main_system.jpg";
						}else if(num == 3){
							document.getElementById("main_img" + num).src = "../img/tbc/main_portfolio.jpg";
						}
					};
					function main_src_on(num) {
						if(num == 0){
							document.getElementById("main_img" + num).src = "../img/tbc/main_areas_on.jpg";
						}else if(num == 1){
							document.getElementById("main_img" + num).src = "../img/tbc/main_lineup_on.jpg";
						}else if(num == 2){
							document.getElementById("main_img" + num).src = "../img/tbc/main_system_on.jpg";
						}else if(num == 3){
							document.getElementById("main_img" + num).src = "../img/tbc/main_portfolio_on.jpg";
						}
					};
					</script>
			...
			<div class="row" style="margin-top: 30px;" id="pc_main">
				<div class="col-lg-3" style="text-align: center; margin-left: 5%;">

					<a href="./estimate.do">
						<img src="../img/tbc/estimate.jpg" alt="견적문의"
						style="max-width: 100%; height: auto; zoom: 1.2;" />
					</a>
				...
				<div class="col-lg-3" style="text-align: center;">
					...
					<a href="./inquiry.do"> <img
						src="../img/tbc/inquiry.jpg" alt="섭외문의"
						style="max-width: 100%; height: auto; zoom: 1.2;" />
					</a>
				...
				<div class="col-lg-3" style="text-align: center;">
					...
					<a href="../TBS/estimate.do" target="_blank"> <img
						src="../img/tbc/tbs_coalition.jpg" alt="시스템문의"
						style="max-width: 100%; height: auto; zoom: 1.2;" />
					</a>
				...
				<div class="col-lg-3" style="text-align: center;">
					...
					<a href="./coalition.do">
						<img src="../img/tbc/coalition.jpg" alt="제휴문의"
						style="max-width: 100%; height: auto; zoom: 1.2;" />
					</a>
		...
		<div class="row" style="margin-top: 30px;" id="pc_main">
			<div class="col-6" style="text-align: center; margin-left: 5%; margin-bottom: 65px;">
				<img src="../img/tbc/Thebigcoperation.jpg" alt="Thebigcoperation"
					style="max-width: 100%; height: auto; zoom: 1.27;" />
			</div>
			<div class="col-6" style="text-align: center;">
				<div style="position: relative; z-index: 1;">
					<img src="../img/tbc/main_contact.jpg"
						alt="고객센터 : 031.000.000, 공연문의하기"
						style="max-width: 100%; height: auto; zoom: 1.27;" />
				</div>
				 <div
							style="position: relative; left: 7%; top: -29%; z-index: 2;">
							<a href="https://www.kakaocorp.com/service/KakaoTalk"
								target="_blank"> <img src="../img/tbc/main_kakao.png"
								alt="고객센터 : 031.000.000, 공연문의하기"
								style="max-width: 100%; height: auto; zoom: 1.27;opacity: 0;" /></a>
						</div> 

			</div>
		</div>

		<div class="row" id="mobile_main">
					<div class="col-lg-6" style="width: 50%">
						<a href="./business_areas.do"> <img
							src="../img/tbc/main_areas.jpg"
							style="max-width: 100%; height: auto;" 행사기획" /></a> <a
							href="./estimate.do" style="max-width: 100%; height: auto;">
							<img
							src="../img/tbc/estimate.jpg"
							alt="견적문의" style="max-width: 100%; height: auto;" />
						</a>
					</div>
					<div class="col-lg-6" style="width: 50%">
						<a href="./lineup.do"> <img
							src="../img/tbc/main_lineup.jpg"
							style="max-width: 100%; height: auto;" alt="매니지먼트" /></a> <a
							href="./inquiry.do" style="max-width: 100%; height: auto;"> <img
							src="../img/tbc/inquiry.jpg"
							alt="섭외문의" style="max-width: 100%; height: auto;" />
						</a>

					</div>
				</div>
				<div class="row" id="mobile_main" style="margin-top: 15px;">
					<div class="col-lg-6" style="width: 50%">
						<a href="../TBS/main.do" target="_blank"> <img
							src="../img/tbc/main_system.jpg"
							style="max-width: 100%; height: auto;" alt="시스템기획" /></a> <a
							href="../TBS/coalition.do" style="max-width: 100%; height: auto; margin-top: 15px;">
							<img
							src="../img/tbc/tbs_coalition.jpg"
							alt="시스템문의" style="max-width: 100%; height: auto;" />
						</a>
					</div>
					<div class="col-lg-6" style="width: 50%">
						<a href="./portfolio.do"> <img
							src="../img/tbc/main_portfolio.jpg"
							style="max-width: 100%; height: auto;" alt="포트폴리오" /></a> <a
							href="./coalition.do" target="_blank"
							style="max-width: 100%; height: auto;"> <img
							src="../img/tbc/coalition.jpg"
							alt="제휴문의" style="max-width: 100%; height: auto;" />
						</a>
				...
				<div class="row" id="mobile_main">
					<div class="col-12">
						<img
							src="../img/tbc/Thebigcoperation.jpg"
							alt="Thebigcoperation" style="max-width: 100%; height: auto; margin-top: 15px;" />
						...
						<div
							style="position: relative; z-index: 2;top: -4.64rem;left: 6.42rem;">
							<a href="https://www.kakaocorp.com/service/KakaoTalk"
								target="_blank"> <img src="../img/tbc/main_kakao.png"
								alt="고객센터 : 031.000.000, 공연문의하기"
								style="max-width: 100%; height: auto; width: 67%;opacity: 0;" /></a>
						</div>
