													...
													<c:when test="${row.answer == 'y'}">
														<tr id="answered" style="display:none;">
															...
															<td><form action="../board/deleteBoard.do" id="delete_frm${row.board_no}">
																...
																<input type="hidden" name="page" value="TBCcoalition">
							...
							<div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="../board/BoardProc.do" id="frm">
                                         <input type="hidden" value="TBCcoalition" name="page">
												...
												<div class="tab-pane active" id="account-2">
													<div class="row">
														<div class="col-lg-6">
															...
															<div class="form-group row mb-3">
																<label class="col-md-3 col-form-label" for="surname1">제휴
																	내용</label>
																<div class="col-md-9">
																	<textarea class="autosize" onkeydown="resize(this)"
																onkeyup="resize(this)" placeholder="제휴내용을 상세히 적어주세요!" name="eventcon" required><%=eventcon%></textarea>
																</div>
															</div>
															<script>
																function resize(
														...
														<div class="col-lg-6">
															...
															<div class="form-group row mb-3">
																<label class="col-md-3 col-form-label" for="surname1">파일업로드</label>
																<div class="col-md-9">
																	<c:import url="https://script.google.com/macros/s/AKfycbxvaZ1hxueNBbsDRPoHZtpQtOTnZAAMLXNLFGtN/exec" />
