...
<head>
		...
		<!-- tbsmain -->
		<link rel="stylesheet" type="text/css" media="screen and (min-width: 768px)" href="../import/css/tbsmain.css">
		...
		<div class="navbar-custom">
			...
			<ul class="list-unstyled topnav-menu topnav-menu-left m-0">
				...
				<li id="dropdown_li2"
					...
					<li id="dropdown_li"
					class="dropdown dropdown-mega d-none d-lg-block"
					style="width: fit-content;height:100px;margin-left: 4.4%;margin-top: 0.2%;"><a id="dropdown_a"
				...
				<li id="dropdown_li"
					class="dropdown dropdown-mega d-none d-lg-block"
					style="width: fit-content;margin-left: 1.5%;margin-top: 0.2%;">
			...
			<div class="content">
				...
				<div class="row" style="margin-bottom: 15px;">
					...
					<div class="swiper-slide"
									...
									<div class="cropping">
										<img src="../img/tbs/tbs_main.jpg" style="height: auto;"
											id="img5">
									</div>
								</div>
				...
				<div class="row" id="pc_main" style="margin-bottom: 15px;">
					<div class="col-12">
						<div id="wrap">
							<div id="container" style="margin-top: 0px;padding-top: 0px;padding-left: 0px;padding-bottom: 0px;padding-right: 0px;">
								<div></div>
								<main>
									...
									<div id="content">
										...
										<div class="sec02">
											<div class="inner">
												...
												<p class="blind"></p>
												<ul class="intro_area">
													<li><a class="lk_more" nclicks="int.pwrlink"
														href="./system.do?select=stage"><img
															alt="1"
															height="450" src="../img/tbs/main_banner1.jpg"
															width="2000"><span class="info_txt"><span
																class="blind"></span></span></a></li>
													<li><a class="lk_more" nclicks="int.shoppingsa"
														href="./system.do?select=sound"><img
															alt="2" height="450"
															src="../img/tbs/main_banner2.jpg" width="2000"><span
															class="info_txt"><span class="blind"></span></span></a></li>
													<li><a class="lk_more" nclicks="int.pwrsa"
														href="./system.do?select=led"><img
															alt="3" height="450"
															src="../img/tbs/main_banner3.jpg" width="2000"><span
															class="info_txt"><span class="blind"></span></span></a></li>
													<li><a class="lk_more" nclicks="int.brandsa"
														href="./system.do?select=light"><img
															alt="4" height="450"
															src="../img/tbs/main_banner4.jpg" width="2000"><span
															class="info_txt"><span class="blind"></span></span></a></li>
													<li><a class="lk_more" nclicks="int.la"
														href="./system.do?select=effect"><img
															alt="5"
															height="450" src="../img/tbs/main_banner5.jpg"
															width="2000"><span class="info_txt"><span
																class="blind"></span></span></a></li>
													<li><a class="lk_more" nclicks="int.la"
														href="./system.do?select=repeater"><img
															alt="6"
															height="450" src="../img/tbs/main_banner6.jpg"
															width="2000"><span class="info_txt"><span
																class="blind"></span></span></a></li>
													<li><a class="lk_more" nclicks="int.la"
														href="./system.do?select=exhibition"><img
															alt="7"
															height="450" src="../img/tbs/main_banner7.jpg"
															width="2000"><span class="info_txt"><span
																class="blind"></span></span></a></li>
													<li><a class="lk_more" nclicks="int.la"
														href="./system.do?select=structure"><img
															alt="8"
															height="450" src="../img/tbs/main_banner8.jpg"
															width="2000"><span class="info_txt"><span
																class="blind"></span></span></a></li>
				...
				<div class="row" id="mobile_main">
					<div class="col-12" style="width: 100%; text-align: right;">
						<div class="cropping">
							<a href="./system.do?select=stage"> <img alt=""
								src="../img/tbs/mobile_main_01.png" id="img1">
							</a>
						</div>
					</div>
				</div>
				<div class="row" id="mobile_main">
					<div class="col-12" style="width: 100%; text-align: left;">
						<div class="cropping">
							<a href="./system.do?select=sound"> <img alt=""
								src="../img/tbs/mobile_main_02.png" id="img2">
							</a>
						</div>
				...
				<div class="row" id="mobile_main">
					<div class="col-12" style="width: 100%; text-align: right;">
						<div class="cropping">
							<a href="./system.do?select=led"> <img alt=""
								src="../img/tbs/mobile_main_03.png" id="img1">
							</a>
						</div>
					</div>
				</div>
				<div class="row" id="mobile_main">
					<div class="col-12" style="width: 100%; text-align: left;">
						<div class="cropping">
							<a href="./system.do?select=light"> <img alt=""
								src="../img/tbs/mobile_main_04.png" id="img2">
							</a>
						</div>
				...
				<div class="row" id="mobile_main">
					<div class="col-12" style="width: 100%; text-align: right;">
						<div class="cropping">
							<a href="./system.do?select=effect"> <img alt=""
								src="../img/tbs/mobile_main_05.png" id="img1">
							</a>
						</div>
					</div>
				</div>
				<div class="row" id="mobile_main">
					<div class="col-12" style="width: 100%; text-align: left;">
						<div class="cropping">
							<a href="./system.do?select=repeater"> <img alt=""
								src="../img/tbs/mobile_main_06.png" id="img2">
							</a>
						</div>
				...
				<div class="row" id="mobile_main">
					<div class="col-12" style="width: 100%; text-align: right;">
						<div class="cropping">
							<a href="./system.do?select=exhibition"> <img alt=""
								src="../img/tbs/mobile_main_07.png" id="img1">
							</a>
						</div>
					</div>
				</div>
				<div class="row" id="mobile_main">
					<div class="col-12" style="width: 100%; text-align: left;">
						<div class="cropping">
							<a href="./system.do?select=structure"> <img alt=""
								src="../img/tbs/mobile_main_08.png" id="img2">
							</a>
						</div>
